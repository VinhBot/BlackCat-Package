...
const blackcat_club_1 = __importDefault(require("../../Publish01/Events"));
/*========================================================
# TicTacToe.js
========================================================*/
class TicTacToe {
            ...
            if (invited) {
                if (!invited.user.bot) {
                    if (inviter.user.id !== invited.user.id && invited.permissionsIn(tunnel.channel).has('ViewChannel')) {
                        ...
                        yield tunnel.replyWith({ content: localize.default.Language_Changer('Modules.Game.tictactoe.tictactoe_4', {
                          username: invited.user.id
                        })}, true);
                    };
                } else {
