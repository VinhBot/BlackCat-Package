...
class I18nProvider {
    constructor() {
        ...
        const localesPath = path_1.default.join(workingDirectory, '.', 'Json');
    ...
    loadFromLocale(locale) {
        ...
        if(!loaded) {
            ...
            console.warn(`Không thể tải tệp ngôn ngữ ${filepath !== null && filepath !== void 0 ? filepath : locale}. Sử dụng mặc định.`);
        }
    }
    __(key, replacements) {
        if(this.localeData && this.localeData[key]) {
            ...
            console.warn(`Không thể tìm thấy ngôn ngữ ${key}. Sử dụng ngôn ngữ khác.`);
            return key;
        }
    }
...
I18nProvider.DEFAULT_LOCALE = 'vi';