const { Client, setDefaultSetting, GatewayIntentBits, Partials, Game: { RockPaperScissors, TicTacToe }} = require("../BlackCat");
...
client.login(process.env.token).then(() => {
  setDefaultSetting({
      ...
      setNewUpdate: false, // nhận trong báo khi có bản cập nhật mới
  });
  // Ready 
  client.on("ready", () => {
