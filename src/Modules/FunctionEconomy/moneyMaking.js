...
const { Currency } = require("../Schema/OptionsSchema");
...
async function rob(settings) {
  ...
  const oldData = user1;
  let user2 = await Currency.findOne({
...
// ===================================================================
// Cái này dành cho Rob Command
function testChance(successPercentage) {
  let random = Math.random() * 10;
  return (random -= successPercentage) < 0;
};

module.exports = { monthly, daily, weekly, quaterly, beg, rob, hafly, hourly, yearly };